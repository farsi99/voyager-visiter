 ...
 */
final class Version20200128144808 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reserver (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, biens_id INT DEFAULT NULL, vehicule_id INT DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, montant DOUBLE PRECISION DEFAULT NULL, date_creation DATETIME NOT NULL, infosuplementaire LONGTEXT DEFAULT NULL, INDEX IDX_B9765E93A76ED395 (user_id), INDEX IDX_B9765E937773350C (biens_id), INDEX IDX_B9765E934A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
