...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Reserver", mappedBy="user")
     */
    private $reservers;
    ...
    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Assert\Length(min="8", minMessage="Votre mot de passe doit contenir au mois 8 caracteres")
     */
    private $motpasse;

    /**
     * @Assert\EqualTo(propertyPath="motpasse", message="Vous n'avez pas tapé le même mot de passe")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Biens", mappedBy="proprio")
     */
    private $biens;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Favoris", mappedBy="booker")
     */
    private $favoris;
    ...
    /**
     * cette méthode reourne le nom complet
     */
    ...
    public function removeFavori(Favoris $favori): self
    {
        if ($this->favoris->contains($favori)) {
            ...
            // set the owning side to null (unless already changed)
            if ($favori->getBooker() === $this) {
                $favori->setBooker(null);
            }
        }
